...
# End time: 18:54:09 on May 28,2022, Elapsed time: 0:07:25
# Errors: 1, Warnings: 2
# vsim -gui work.exbufsinteg 
# Start time: 18:54:09 on May 28,2022
...
# vsim -gui work.exbufsinteg 
# Start time: 18:46:44 on May 28,2022
# Loading std.standard
# Loading std.textio(body)
# Loading ieee.std_logic_1164(body)
# Loading work.exbufsinteg(arch)
...
# Loading work.exmem_buf(arch)
# vsim -gui work.exbufsinteg 
# Start time: 17:41:25 on May 28,2022
# Loading std.standard
# Loading std.textio(body)
# Loading ieee.std_logic_1164(body)
# Loading work.exbufsinteg(arch)
...
#           Attempting to use alternate WLF file "./wlfts0geee".
# ** Warning: (vsim-WLF-5001) Could not open WLF file: vsim.wlf
#           Using alternate file: ./wlfts0geee
# ** Warning: (vsim-WLF-5000) WLF file currently in use: vsim.wlf
#           File in use by: mody7  Hostname: LAPTOP-07B90H95  ProcessID: 8860
...
vsim -gui work.exbufsinteg
# End time: 18:55:11 on May 28,2022, Elapsed time: 0:01:02
# Errors: 0, Warnings: 2
# vsim -gui work.exbufsinteg 
# Start time: 18:55:11 on May 28,2022
# Loading std.standard
# Loading std.textio(body)
# Loading ieee.std_logic_1164(body)
# Loading work.exbufsinteg(arch)
...
run
run
force -freeze sim:/exbufsinteg/instruction 00110100000100000010000000000000 0
run
